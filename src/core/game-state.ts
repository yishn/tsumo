...
export class DealPhase extends Phase {
...
export class EndActionPhase extends Phase {
...
export class ReactionPhase extends Phase {
  pongKong(
    playerIndex: number,
    tileIndex1: number,
    tileIndex2: number,
...
export class GameState<P extends Phase = any> {
  phase: P;
  deck: Tile[] = [];
